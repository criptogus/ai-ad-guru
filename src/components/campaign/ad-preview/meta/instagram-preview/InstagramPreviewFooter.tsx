  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-3 text-left">
      ...
      {ad.hashtags && ad.hashtags.length > 0 && (
        <div className="mt-1 text-sm text-blue-500 dark:text-blue-400 text-left">
      ...
      <div className="mt-2">
        <button className="w-full py-1.5 rounded bg-[#0095f6] dark:bg-[#0095f6] text-white font-semibold text-sm transition-all duration-200 hover:bg-[#0086e0] active:scale-[0.98]">
